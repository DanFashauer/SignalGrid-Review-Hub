...
messy idea
    ↓
/prompt-master     brain dump in, clean task spec out (a command; the vendored nidhinjs/prompt-master SKILL is a different namespace and both load — VENDORED.md "Name twins")
    ↓
