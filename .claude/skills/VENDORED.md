...
| Overrides | Two rows in the table above: `prompt-master/SKILL.md:72` (a live fetch of provider documentation) and `prompt-master/SKILL.md:402` (two tasks → two prompt blocks, against its own single-block format). |
