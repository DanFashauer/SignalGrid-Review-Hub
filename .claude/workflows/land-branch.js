...
0. \`cd ${worktree} && { test -x scripts/node_modules/.bin/tsx || pnpm install --frozen-lockfile; }\` — an uninstalled worktree (root node_modules missing or a symlink) fails the chain at the first tsx proof (L17); report the install's last line in gateResults if it ran.
${preBrief}
