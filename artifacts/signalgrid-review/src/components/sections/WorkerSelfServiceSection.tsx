...
const SCENARIOS: WorkerScenario[] = [
  ...
  { worker: "Rin O.", role: "Nurse", device: "Ward iPad 06", identityRef: "nurse.baseline_drift", deviceRef: "ipad-ward-06", workflowKey: "clinical-session", workflowLabel: "Clinical session" },
];
