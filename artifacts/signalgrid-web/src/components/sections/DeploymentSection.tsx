...
const DEPLOYMENT_OPTIONS = [
  ...
  },
  {
    ...
    features: [
      ...
      "Single-node Docker Compose today; scaling and HA are not configurable",
    ],
  ...
  },
  {
    ...
    desc: "An air-gap deployment DESIGN for critical infrastructure, DoD, and IC environments — modeled on public-safe fixtures, not an available offering.",
    features: [
      "Zero external network connectivity (design)",
      "Offline license and update model (design intent)",
      "SCAP/XCCDF benchmark mapping",
      "IL4 / IL5-oriented architecture (design target)",
    ],
