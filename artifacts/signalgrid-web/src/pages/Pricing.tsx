...
const TIERS = [
  ...
  },
  {
    ...
    desc: "Air-gap-oriented deployment DESIGN for government and defense, modeled on public-safe fixtures — a design conversation, not an available offering (pre-announcement).",
    highlight: false,
    cta: "Request a conversation",
    features: [
      { text: "Deployment DESIGN conversation — modeled on public-safe fixtures, not an available offering", ok: false },
      { text: "Air-gap-oriented deployment design (roadmap, not delivered)", ok: false },
      { text: "FedRAMP path — roadmap, not authorized", ok: false },
      { text: "Consumes CIS/STIG/SCAP benchmark results as a decision signal — SignalGrid does not run the scan", ok: true },
      { text: "Design-partner engagement — sought, not yet established", ok: false },
    ],
  },
];
