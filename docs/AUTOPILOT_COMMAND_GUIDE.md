...
- `New input: <link/screenshot>` means classify the input and either park it or build one next eligible phase.
- `Build next phase` means use the backlog and start the highest-priority eligible phase.
