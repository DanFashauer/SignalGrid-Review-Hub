...
4. **Supply four billing numbers** — PARTIALLY ANSWERED 2026-08-21, owner's words: "the billing info so far is actually 200 monthly for Claude and 20 monthly also for ChatGPT the domain was I think 30 max." Recorded as stated, never adjusted: Claude $200/month; ChatGPT $20/month (a fifth line the original list did not have — it pays for the cross-lane Codex reviewer); domains ~$30 (owner-approximate, cadence unconfirmed — assumed one-time/annual pending confirmation). STILL OWED: Apple Developer status/fee, GitHub plan and sibling-repo visibility.
