...
1. lib/signalgrid-core/src/engine.ts (633) — SignalGridCore itself; every /v1 decision flows through it via api-server lib/core.ts.
...
6. lib/signalgrid-core/src/store.ts (526) — in-memory store semantics behind every tenant-scoped read; a cross-tenant leak would live here.
...
21. scripts/preflight.mjs (743) — the per-push lane CI mirrors; a gate mis-registered here disappears quietly.
