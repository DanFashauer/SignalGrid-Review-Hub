...
## DR-044 — build-lane model-routing tap: chores may route low-stakes, fully-recheckable work to the DR-029 gateway through a report-only helper, fenced out of the decision path by construction (owner-directed 2026-09-09)
