...
**Status: PROPOSED — lands only by the owner's merge.** The pull request touches `scripts/**`, `.github/workflows/**` and this file, which `scripts/check-owner-gated-surfaces.mjs` classifies as safety machinery; no model-judged merge may land it.
