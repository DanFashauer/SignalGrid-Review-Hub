...
- Deterministic PASS/FAIL validation for compliant, non-compliant, stale, missing-device, lookup-failure, malformed-payload, and unmanaged-device cases.
...
```text
Device ID
  -> deterministic Microsoft posture/compliance fixture
...
- [x] Deterministic sample payloads cover compliant, non-compliant, stale, missing, lookup-failure, malformed-payload, and unmanaged-device cases.
