...
`scripts/launch-profile.mjs` classifies **183 classified items** across **4 profile
...
| `deferred` | **132 deferred items** | Real, gated, proven, staying in the repository — not Limited GA. |
