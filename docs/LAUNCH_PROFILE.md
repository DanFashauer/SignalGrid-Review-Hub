...
`scripts/launch-profile.mjs` classifies **179 classified items** across **4 profile
...
| `internal` | **14 internal items** | Harness, generator or evidence plumbing. Not a product surface at all. |
