...
`scripts/launch-profile.mjs` classifies **185 classified items** across **4 profile
...
| `internal` | **16 internal items** | Harness, generator or evidence plumbing. Not a product surface at all. |
