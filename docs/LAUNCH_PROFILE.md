...
`scripts/launch-profile.mjs` classifies **175 classified items** across **4 profile
...
| `internal` | **10 internal items** | Harness, generator or evidence plumbing. Not a product surface at all. |
