...
`scripts/launch-profile.mjs` classifies **178 classified items** across **4 profile
...
| `internal` | **13 internal items** | Harness, generator or evidence plumbing. Not a product surface at all. |
