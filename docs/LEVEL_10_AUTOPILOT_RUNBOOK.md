...
8. **ChatGPT reviews GitHub state directly** from PRs, run URLs, files, and artifacts instead of asking the owner to paste long automation summaries. *(Retired reviewer as of 2026-09-06 — `docs/COMPANY_BUILD_PLAN.md` records it; the adversarial pass that exists is the in-repo Reviewer role, `docs/agent/ORG.md` and `.claude/skills/signalgrid-reviewer/SKILL.md`.)*
