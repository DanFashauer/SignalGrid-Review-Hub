...
| Private-core implementation plan | A note that real connectors belong in the private/core/local implementation because they may require credentials, API keys, tenant data, webhook secrets, monitoring access, tool permissions, and private test data.                                                                                | Public Review Hub stays documentation-first and deterministic.                                           |
