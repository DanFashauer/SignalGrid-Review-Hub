...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 505 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 505 deterministic invariant assertions
