...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 221 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 221 deterministic invariant assertions
