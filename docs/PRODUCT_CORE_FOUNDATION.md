...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 225 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 225 deterministic invariant assertions
