...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 206 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 206 deterministic invariant assertions
