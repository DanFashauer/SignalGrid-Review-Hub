...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 538 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 538 deterministic invariant assertions
