...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 188 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 188 deterministic invariant assertions
