...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 163 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 163 deterministic invariant assertions
