...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 519 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 519 deterministic invariant assertions
