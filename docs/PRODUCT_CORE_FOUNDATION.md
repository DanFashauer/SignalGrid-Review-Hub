...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 209 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 209 deterministic invariant assertions
