...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 239 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 239 deterministic invariant assertions
