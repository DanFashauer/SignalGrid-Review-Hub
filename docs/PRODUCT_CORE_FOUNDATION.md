...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 261 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 261 deterministic invariant assertions
