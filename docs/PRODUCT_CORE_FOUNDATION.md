...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 495 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 495 deterministic invariant assertions
