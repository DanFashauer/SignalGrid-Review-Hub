...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 570 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 570 deterministic invariant assertions
