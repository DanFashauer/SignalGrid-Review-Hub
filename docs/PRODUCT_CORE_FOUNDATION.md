...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 526 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 526 deterministic invariant assertions
