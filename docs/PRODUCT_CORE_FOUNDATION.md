...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 166 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 166 deterministic invariant assertions
