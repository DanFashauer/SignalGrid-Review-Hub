...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 597 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 597 deterministic invariant assertions
