...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 243 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 243 deterministic invariant assertions
