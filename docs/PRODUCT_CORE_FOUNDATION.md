...
| Proof | `scripts/src/signalgrid-core-proof.ts` | `pnpm run proof:signalgrid-core` — 509 invariant assertions |
...
```bash
pnpm install
pnpm run proof:signalgrid-core          # 509 deterministic invariant assertions
