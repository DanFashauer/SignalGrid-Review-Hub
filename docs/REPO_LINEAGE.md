...
| --- | --- | --- | --- |
| `DanFashauer/SignalGrid` | Private protected source, backup, and core foundation. | Core implementation, protected architecture, internal proof code, sensitive integration work, private roadmap details, security-sensitive decisions. | Public marketing drafts that do not need protected access, personal portfolio content, unvalidated public claims. |
