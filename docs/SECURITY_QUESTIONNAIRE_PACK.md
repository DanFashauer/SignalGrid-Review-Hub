...
| Data retention? | **Owner decision pending** — retention durations are on the owner's open decision list and no default is claimed. | — | Not built, not claimed |
