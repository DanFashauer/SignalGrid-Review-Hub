...
| 16 | Outdated vendor access privileges | Contractor remote credentials stay open for years | `credential-rotation` (49th family), `access-governance` leaver processing |
