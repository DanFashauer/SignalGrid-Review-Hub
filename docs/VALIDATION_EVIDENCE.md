...
| Group | Gates | Result |
|---|---|---|
| Real-life simulator | `proof:signalgrid-simulator` (11 scenarios / 51 assertions at that time — 73/73 on 2026-09-06; **the scenario count has since moved**: the smart-charging custody journey added five ordered stages and four failure branches on 2026-09-14 under DR-054 — fixture-backed, over deferred families — and the same run reads 20 scenarios / 113 assertions, `pnpm run proof:signalgrid-simulator`), `proof:custody-journey`, `proof:room-sim`, `proof:signalgrid-core`, `proof:signalgrid-grid` | PASS |
