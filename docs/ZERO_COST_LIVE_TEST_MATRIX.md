...
| API surface | API integration test (boots the real server, 199 assertions — incl. the session lifecycle, previously unexercised), OpenAPI contract check, Postman collection kept in sync | The wire contract | $0 |
