...
**What git carries byte-identically on pull** (`docs/MCP_AND_SKILLS_LANE_PARITY.md`, canonical): `.claude/skills/` (30 tracked dirs), `.claude/agents/` (13), `.claude/commands/`, `.claude/settings.json`, `.claude/hooks/*.sh`, `.mcp.json` (`signalgrid-mcp` only, no creds), `.claude-plugin/plugin.json` (DR-030), and `docs/*`.
