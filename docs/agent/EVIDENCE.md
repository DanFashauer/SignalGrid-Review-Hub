...
Output:
```
  NEXT-ACTION CLOCK (as of 2026-09-07, the roster file's own latest commit date) — 34 role(s) with nextAction older than 7d:
    · competitive-analyst — nextAction older than 7d (set 2026-08-19, 19d ago)
    · docs-writer — nextAction older than 7d (set 2026-08-19, 19d ago)
    ... (32 more)
