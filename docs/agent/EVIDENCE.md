...
mutation (doc): one planted line → "MISSING 1 … docs/MAC_LANE.md:318 "PLANTED_MISSING_KEY" ∉ lib/verdict-attestation/src/attest.ts" and "✗ Cited-symbol ratchet ROSE: missing 0 → 1", exit 1; reverted from the .mutbak copy, tree clean
