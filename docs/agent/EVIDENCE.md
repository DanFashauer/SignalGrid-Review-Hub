...
after the change: bash syntax ok; sim-scripts-selfcheck 9 script(s) checked statically, 0 problem(s); Drift check passed — every proof runs in both places; preflight↔CI parity: 373 preflight gates, 16 workflow files, 0 unwired
```
