...
node scripts/mutation-guard.mjs --proof=proof:rtls-custody
node scripts/check-proof-figures.mjs                      # three runs: plant "865 combos" (must fail), plant "57,601" (must fail), real (must pass)
...
PLANT 865 combos  → ✗ docs/PHYSICAL_CUSTODY_SIGNAL_MODEL.md — "865 combos" in a section about proof:rtls-custody, ... Figure guard FAILED: 1 problem.
PLANT 57,601      → ✗ docs/PHYSICAL_CUSTODY_SIGNAL_MODEL.md — "57,601" is stated in a section about proof:rtls-custody, ... Figure guard FAILED: 1 problem.
