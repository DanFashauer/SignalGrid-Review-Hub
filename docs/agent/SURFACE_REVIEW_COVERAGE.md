...
Coverage of the tree is asserted, not assumed: **2143 of 2143 in-scope tracked files** belong to a surface on this page (52 more are in declared out-of-scope trees). A file belonging to no surface fails the gate.
...
| `.claude/skills` | tree | 63 | **partial** | 1 | 2026-09-02 | cloud lane | #379 | 3 | 0 |
...
| `artifacts/lane-messages` | tree | 125 | **NOT READ** | 0 | — | — | — | 0 | 0 |
...
| `artifacts/sim-requests` | tree | 15 | **NOT READ** | 0 | — | — | — | 0 | 0 |
...
| `docs/*` | loose files | 212 | **NOT READ** | 0 | — | — | — | 0 | 0 |
...
| `docs/research` | docs family | 47 | **NOT READ** | 0 | — | — | — | 0 | 0 |
...
| `native/ios/EnterpriseShell` | native | 48 | read | 1 | 2026-09-02 | cloud lane (independent review, notes folded) | #387 | 4 | 0 |
| `native/ios/EnterpriseShellTests` | native | 8 | **NOT READ** | 0 | — | — | — | 0 | 0 |
...
| `scripts` | package | 376 | **NOT READ** | 0 | — | — | — | 0 | 0 |
