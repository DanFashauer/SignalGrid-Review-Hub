...
Coverage of the tree is asserted, not assumed: **2239 of 2239 in-scope tracked files** belong to a surface on this page (52 more are in declared out-of-scope trees). A file belonging to no surface fails the gate.
...
| `artifacts/lane-messages` | tree | 165 | **NOT READ** | 0 | — | — | — | 0 | 0 |
...
| `native/ios/EnterpriseShellTests` | native | 9 | read | 1 | 2026-09-05 | cloud lane (five independent audit agents + firsthand read of every edit site) | docs/agent/EVIDENCE.md | 1 | 0 |
...
| `scripts` | package | 388 | **partial** | 1 | 2026-09-05 | cloud lane | docs/agent/EVIDENCE.md | 4 | 0 |
