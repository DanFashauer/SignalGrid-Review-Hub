...
Coverage of the tree is asserted, not assumed: **2286 of 2286 in-scope tracked files** belong to a surface on this page (52 more are in declared out-of-scope trees). A file belonging to no surface fails the gate.
