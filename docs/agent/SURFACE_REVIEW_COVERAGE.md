...
| `native/ios/EnterpriseShellTests` | native | 14 | read | 1 | 2026-09-05 | cloud lane (five independent audit agents + firsthand read of every edit site) | docs/agent/EVIDENCE.md | 1 | 0 |
...
| `native/shared` | native | 5 | read | 1 | 2026-09-02 | cloud lane (two independent passes) | #386 | 0 | 0 |
