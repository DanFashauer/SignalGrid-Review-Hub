...
| `.claude/skills` | tree | 824 | read | 4 | 2026-09-06 | cloud lane (one independent fail-closed audit agent + firsthand read of every edit site and of the hook's verdicts) | docs/agent/EVIDENCE.md | 21 | 1 |
...
| `.specify` | tree | 20 | read | 1 | 2026-09-18 | cloud lane (intake by use, 2026-09-18) | docs/agent/RESOURCE_INTAKE.md | 0 | 0 |
