...
Coverage of the tree is asserted, not assumed: **2150 of 2150 in-scope tracked files** belong to a surface on this page (52 more are in declared out-of-scope trees). A file belonging to no surface fails the gate.
...
| `artifacts/lane-messages` | tree | 126 | **NOT READ** | 0 | — | — | — | 0 | 0 |
...
| `docs/*` | loose files | 213 | **NOT READ** | 0 | — | — | — | 0 | 0 |
