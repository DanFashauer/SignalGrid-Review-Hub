...
// control, data-protection / DLP, cross-domain detections) into one unified device
// risk posture + the strongest action any signal warrants. Pure and deterministic.
export * from "./types";
export * from "./compose";
