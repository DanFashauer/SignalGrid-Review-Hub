...
// threat-state, identity/SSO sign-in risk, cross-domain detections) into ONE
// decision-relevant answer — the strongest action any signal warrants and the
// overall risk tier — with the drivers that produced it. Pure and deterministic.
