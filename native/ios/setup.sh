...
if [ $? -eq 0 ]; then
    ...
    echo "   open EnterpriseShell.xcodeproj"
    echo ""
    echo "🔧 To build from command line:"
    echo "   xcodebuild -project EnterpriseShell.xcodeproj -scheme EnterpriseShell -sdk iphonesimulator -configuration Debug build"
    echo ""
