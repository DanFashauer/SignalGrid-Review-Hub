...
export const SWEEP_EXEMPT = [
  {
    ...
    count: 1,
    reason:
      "a dated observation in the 2026-09-17 LAST TOUCHED paragraph — the proof count as it stood when two " +
      "modules were cross-checked, quoted as a before/after pair. It became a second home for the current " +
      "figure only because the tree later derived 148 again (2026-09-18, proof:estate-core).",
  },
  {
    ...
    count: 1,
    reason:
      "generated by gen-claim-inventory-md.mjs: row 183's quoted text ends in 'the proofs check' and the NEXT " +
      "cell is the claim id 148 — a row number, not a proof count. Owned by check-claim-inventory-anchors.mjs.",
  },
  {
    doc: "docs/STATUS.md",
    near: /proof gates: \*\*\d+/,
