...
export const SWEEP_EXEMPT = [
  {
    ...
    near: /requests `limit: 100/,
    count: 2,
    reason:
      "generated by gen-claim-inventory-md.mjs: two quoted claim rows cite the `limit: 100` query-parameter ceiling " +
      "on list requests — a request ceiling, not a count of Bruno request files. Owned by check-claim-inventory-anchors.mjs.",
  },
  {
    doc: "docs/company/ROLE_CATALOG.md",
    near: /100 percent of pull requests/,
    count: 2,
    reason:
      "a percentage in two role descriptions ('100 percent of pull requests' reviewed) — a share, not a count of " +
      "Bruno request files; the word 'requests' is what put it in the sweep's window.",
  },
  {
    doc: "docs/STATUS.md",
    near: /proof gates: \*\*\d+/,
