 ...
 * one that self-skips without an env var, and — the ratchet — when a binding is removed
 * without docs/agent/launch-proof-bindings-record.json changing in the same diff.
 * Non-launch entries may not carry `proofs`.
