...
const STEPS = [
  ...
  { name: "Posture-allow conformance (the shared vectors bind the TS side; the Swift twin is REPORTED pending)", cmd: ["node", "scripts/check-posture-allow-conformance.mjs"] },
