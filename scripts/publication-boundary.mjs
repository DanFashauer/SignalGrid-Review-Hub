...
export const AREAS = [
  ...
  { path: ".claude/skills/signalgrid", class: "tooling", reason: "First-party SignalGrid skill, authored here on 2026-08-22 (fa0e32e) \u2014 after the obra/superpowers vendoring on 2026-08-20. Not part of the 14 vendored skills; carved out so the third_party_intake claim above stays literally true." },
  { path: ".claude/skills/signalgrid-core", class: "tooling", reason: "First-party SignalGrid skill, authored here on 2026-08-22 (fa0e32e) \u2014 after the obra/superpowers vendoring on 2026-08-20. Not part of the 14 vendored skills; carved out so the third_party_intake claim above stays literally true." },
  { path: ".claude/skills/signalgrid-native", class: "tooling", reason: "First-party SignalGrid skill, authored here on 2026-08-22 (fa0e32e) \u2014 after the obra/superpowers vendoring on 2026-08-20. Not part of the 14 vendored skills; carved out so the third_party_intake claim above stays literally true." },
  { path: ".claude/skills/signalgrid-reviewer", class: "tooling", reason: "First-party SignalGrid skill, authored here on 2026-08-22 (fa0e32e) \u2014 after the obra/superpowers vendoring on 2026-08-20. Not part of the 14 vendored skills; carved out so the third_party_intake claim above stays literally true." },
  { path: ".claude/skills/signalgrid-scribe", class: "tooling", reason: "First-party SignalGrid skill, authored here on 2026-08-22 (fa0e32e) \u2014 after the obra/superpowers vendoring on 2026-08-20. Not part of the 14 vendored skills; carved out so the third_party_intake claim above stays literally true." },
  ...
  { path: ".claude/skills/signalgrid-evidence-toolchain", class: "tooling", reason: "First-party SignalGrid skill, authored here on 2026-08-26 (f748408, #321) \u2014 after the obra/superpowers vendoring on 2026-08-20. Not part of the 14 vendored skills; carved out so the third_party_intake claim above stays literally true. Found 2026-09-02 by the agent-platform-steward: three first-party skills had no carve-out and were classified as another author's work for a week; section E of the gate now counts the uncovered directories against the vendored figure so the next one cannot." },
  { path: ".claude/skills/loop-start", class: "tooling", reason: "First-party session-start ritual, authored here on 2026-08-31 (e075109, DR-021). Not part of the 14 vendored skills; carved out so the third_party_intake claim above stays literally true." },
  ...
  { path: ".claude/skills/tool-evaluation-by-use", class: "tooling", reason: "First-party intake skill, authored here on 2026-09-12 — after the obra/superpowers vendoring on 2026-08-20. Not part of the 14 vendored skills; carved out so the third_party_intake claim above stays literally true. Captures the by-use evaluation the cloud lane ran on Graphify that day (docs/agent/RESOURCE_INTAKE.md, 2026-09-12): pin, read, sandbox against a copy with no keys, measure offline and for determinism, recompute the headline denominator." },
  { path: ".claude/skills/media-intake", class: "tooling", reason: "First-party intake skill, authored here on 2026-09-12 — after the obra/superpowers vendoring on 2026-08-20. Not part of the 14 vendored skills; carved out so the third_party_intake claim above stays literally true. Records how the two owner-shared videos of 2026-09-12 were handled: transcribed locally, media and transcript kept out of the tree under this boundary, substance placed in the document it belongs to." },
  { path: ".claude/skills/landing-under-dr-037", class: "tooling", reason: "First-party landing skill, authored here on 2026-09-12 — after the obra/superpowers vendoring on 2026-08-20. Not part of the 14 vendored skills; carved out so the third_party_intake claim above stays literally true. Holds DR-037's five merge conditions and the merge-Alpha-then-regenerate order the cloud lane used to land #656, #657, #653, #649 and #654." },
  { path: ".claude/skills/orchestrator-over-workers", class: "tooling", reason: "First-party build-pattern skill, authored here on 2026-09-12 — after the obra/superpowers vendoring on 2026-08-20. Not part of the 14 vendored skills; carved out so the third_party_intake claim above stays literally true. The orchestrator-over-Opus-workers pattern recorded in docs/LANE_COORDINATION.md the same day, with the two review pitfalls the first fan-out produced." },
