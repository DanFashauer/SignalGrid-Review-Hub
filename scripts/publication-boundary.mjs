...
export const AREAS = [
  ...
  { path: ".claude-plugin", class: "tooling", reason: "The Claude Code plugin manifest (DR-030) that packages this repo's operating plane as the `signalgrid` plugin. Names skills/agents/commands by path into the public .claude/; no secrets, endpoints, tenant or customer material." },
  ...
  { path: ".claude/skills", class: "third_party_intake", reason: "110 skills vendored unmodified, from fourteen upstreams: obra/superpowers, 14 under MIT © 2025 Jesse Vincent; bradautomates/claude-video, 1 under MIT © 2026 Bradley Bonanno (DR-040); mattpocock/skills, 25 under MIT © 2026 Matt Pocock; addyosmani/agent-skills, 24 under MIT © 2025 Addy Osmani; K-Dense-AI/scientific-agent-skills, 13 under MIT © 2025 K-Dense Inc. (each also MIT in its own frontmatter); google/skills, 5 under Apache-2.0 (Google LLC); NVIDIA/skills, 4 under Apache-2.0 and, for nvidia-skill-finder, CC-BY-4.0 AND Apache-2.0 (NVIDIA CORPORATION & AFFILIATES); mcollina/skills, 4 under MIT © 2026 Matteo Collina; raintree-technology/hig-doctor, 3 under MIT © 2025 Raintree Technology; Neeeophytee/finding-unknowns-skills, 3 under MIT © 2026 Neeeophytee; rainmanjam/poka-yoke, 2 under MIT © 2026 rainmanjam; oliver-zehentleitner/keep-the-why, 1 under MIT © 2026 Oliver Zehentleitner; conorluddy/ios-simulator-skill, 1 under MIT © 2025 Conor Luddy; github/spec-kit, 10 under MIT © GitHub, Inc. (2026-09-18, the ten speckit-* skills `specify init --integration claude` scaffolds at pin 5e952140). Every vendored directory carries its upstream LICENSE. Licence basis, upstream commits, the per-upstream exclusions and the rejected alternatives are stated in .claude/skills/VENDORED.md." },
  ...
  { path: ".claude/agents", class: "third_party_intake", reason: "NINE of the thirteen agent definitions are activated from third_party/everything-claude-code/agents/, byte-identical to that source under MIT (c) 2026 Affaan Mustafa: architect, build-error-resolver, code-reviewer, doc-updater, e2e-runner, planner, refactor-cleaner, security-reviewer, tdd-guide. The other FOUR are first-party and carry their own carve-outs below \u2014 this directory-level class once covered them too, publishing this company's own work under another author's grant. Drift from the vendored copy is a re-vendor decision, not an edit." },
  ...
  { path: ".claude/agents/fail-closed-auditor.md", class: "tooling", reason: "First-party agent definition, authored here. No counterpart exists in third_party/everything-claude-code/agents/ \u2014 verified by cmp against that tree. Carved out of the .claude/agents third_party_intake class so this repository does not publish its own work under another author's MIT grant." },
  { path: ".claude/agents/gate-and-proof-engineer.md", class: "tooling", reason: "First-party agent definition, authored here. No counterpart exists in third_party/everything-claude-code/agents/ \u2014 verified by cmp against that tree. Carved out of the .claude/agents third_party_intake class so this repository does not publish its own work under another author's MIT grant." },
  { path: ".claude/agents/verdict-core-reader.md", class: "tooling", reason: "First-party agent definition, authored here. No counterpart exists in third_party/everything-claude-code/agents/ \u2014 verified by cmp against that tree. Carved out of the .claude/agents third_party_intake class so this repository does not publish its own work under another author's MIT grant." },
  { path: ".claude/agents/agent-platform-steward.md", class: "tooling", reason: "First-party agent definition, authored here. No counterpart exists in third_party/everything-claude-code/agents/ \u2014 verified by cmp against that tree. Carved out of the .claude/agents third_party_intake class so this repository does not publish its own work under another author's MIT grant." },
  { path: ".claude/skills/signalgrid", class: "tooling", reason: "First-party SignalGrid skill, authored here on 2026-08-22 (fa0e32e) \u2014 after the obra/superpowers vendoring on 2026-08-20. Not part of the 110 vendored skills; carved out so the third_party_intake claim above stays literally true." },
  { path: ".claude/skills/signalgrid-core", class: "tooling", reason: "First-party SignalGrid skill, authored here on 2026-08-22 (fa0e32e) \u2014 after the obra/superpowers vendoring on 2026-08-20. Not part of the 110 vendored skills; carved out so the third_party_intake claim above stays literally true." },
  { path: ".claude/skills/signalgrid-native", class: "tooling", reason: "First-party SignalGrid skill, authored here on 2026-08-22 (fa0e32e) \u2014 after the obra/superpowers vendoring on 2026-08-20. Not part of the 110 vendored skills; carved out so the third_party_intake claim above stays literally true." },
  { path: ".claude/skills/signalgrid-reviewer", class: "tooling", reason: "First-party SignalGrid skill, authored here on 2026-08-22 (fa0e32e) \u2014 after the obra/superpowers vendoring on 2026-08-20. Not part of the 110 vendored skills; carved out so the third_party_intake claim above stays literally true." },
  { path: ".claude/skills/signalgrid-scribe", class: "tooling", reason: "First-party SignalGrid skill, authored here on 2026-08-22 (fa0e32e) \u2014 after the obra/superpowers vendoring on 2026-08-20. Not part of the 110 vendored skills; carved out so the third_party_intake claim above stays literally true." },
  { path: ".claude/skills/signalgrid-master", class: "tooling", reason: "First-party SignalGrid orchestration skill, mirrored here on 2026-08-25 (29adc48) per DR-018 from the owner's synced skills. Its own frontmatter declares author: SignalGrid, licence MIT. Carved out because WITHOUT this entry it fell under the .claude/skills third_party_intake class and this repository published its own work under obra/superpowers' MIT grant \u2014 the exact harm the neighbouring carve-outs exist to prevent. Found on the first activation shift of agent-platform-engineer, 2026-08-25; the boundary gate stayed green throughout because it proves every path is CLASSIFIED, never that a path is classified CORRECTLY." },
  { path: ".claude/skills/signalgrid-evidence-toolchain", class: "tooling", reason: "First-party SignalGrid skill, authored here on 2026-08-26 (f748408, #321) \u2014 after the obra/superpowers vendoring on 2026-08-20. Not part of the 110 vendored skills; carved out so the third_party_intake claim above stays literally true. Found 2026-09-02 by the agent-platform-steward: three first-party skills had no carve-out and were classified as another author's work for a week; section E of the gate now counts the uncovered directories against the vendored figure so the next one cannot." },
  { path: ".claude/skills/loop-start", class: "tooling", reason: "First-party session-start ritual, authored here on 2026-08-31 (e075109, DR-021). Not part of the 110 vendored skills; carved out so the third_party_intake claim above stays literally true." },
  { path: ".claude/skills/loop-end", class: "tooling", reason: "First-party session-end ritual, authored here on 2026-08-31 (e075109, DR-021). Not part of the 110 vendored skills; carved out so the third_party_intake claim above stays literally true." },
  { path: ".claude/skills/research-ops", class: "tooling", reason: "First-party evidence-first research skill, authored here on 2026-09-03 — after the obra/superpowers vendoring on 2026-08-20. Not part of the 110 vendored skills; carved out so the third_party_intake claim above stays literally true. Absorbed by use from the MCP Market leaderboards the owner shared (docs/research/MCP_MARKET_LEADERBOARDS.md), which name research/market/discovery skills repeatedly." },
  { path: ".claude/skills/stack-reference", class: "tooling", reason: "First-party stack quick-reference skill, authored here on 2026-09-04 — after the obra/superpowers vendoring on 2026-08-20. Not part of the 110 vendored skills; carved out so the third_party_intake claim above stays literally true. Absorbed by use from the Fechin/reference cheatsheet site the owner shared (docs/agent/RESOURCE_INTAKE.md, 2026-09-04): 215 sheets held against this tree by nine reader agents, the doubtful commands run on the Mac lane, kept as the 102 contradictions between generic advice and this repository's rules plus the items that survived." },
  { path: ".claude/skills/cli-anything", class: "tooling", reason: "First-party adapter skill, authored here on 2026-09-12 (DR-040): how the CLI-Anything method vendored under third_party/cli-anything/ applies to this repository's own control plane. Not part of the 110 vendored skills; carved out so the third_party_intake claim above stays literally true." },
  { path: ".claude/skills/video-intake", class: "tooling", reason: "First-party video-intake skill, authored here on 2026-09-12 (DR-040): frames through the vendored watch/ skill, a transcript produced locally with faster-whisper, an intake row. Not part of the 110 vendored skills; carved out so the third_party_intake claim above stays literally true." },
  { path: ".claude/skills/tool-evaluation-by-use", class: "tooling", reason: "First-party intake skill, authored here on 2026-09-12 — after the obra/superpowers vendoring on 2026-08-20. Not part of the 110 vendored skills; carved out so the third_party_intake claim above stays literally true. Captures the by-use evaluation the cloud lane ran on Graphify that day (docs/agent/RESOURCE_INTAKE.md, 2026-09-12): pin, read, sandbox against a copy with no keys, measure offline and for determinism, recompute the headline denominator." },
  // github/spec-kit's project scaffold, 2026-09-18 (RESOURCE_INTAKE.md row of that date).
  // Vendored at pin 5e952140 exactly as `specify init --here --integration claude
  // --ignore-agent-tools` writes it, MINUS anything that registers a hook: the only path
  // that writes .claude/settings.json is an --extension, and none is taken. Its own
  // .gitignore keeps feature.json (per-checkout state) out of the tree, so provenance
  // stays clean. The constitution below it is FIRST-PARTY content in a third-party slot
  // and is carved out so this claim stays literally true.
  { path: ".specify", class: "third_party_intake", reason: "github/spec-kit project scaffold, 19 files vendored unmodified under MIT © GitHub, Inc. at pin 5e952140659287106580d32f242ba71365a3862b (2026-09-18): templates, bash scripts, workflow and integration manifests. No hook, no network, no branch creation — each measured in the intake row. The one first-party file inside it is carved out below." },
  { path: ".specify/memory/constitution.md", class: "tooling", reason: "First-party: SignalGrid's own constitution, written here on 2026-09-18 from CLAUDE.md's golden rules into the slot spec-kit's /speckit-plan and /speckit-analyze check against. Not GitHub's work; carved out so the .specify third_party_intake claim above stays literally true." },
  { path: ".claude/skills/landing-under-dr-037", class: "tooling", reason: "First-party landing skill, authored here on 2026-09-12 — after the obra/superpowers vendoring on 2026-08-20. Not part of the 110 vendored skills; carved out so the third_party_intake claim above stays literally true. Holds DR-037's five merge conditions and the merge-Alpha-then-regenerate order the cloud lane used to land #656, #657, #653, #649 and #654." },
  { path: ".claude/skills/orchestrator-over-workers", class: "tooling", reason: "First-party build-pattern skill, authored here on 2026-09-12 — after the obra/superpowers vendoring on 2026-08-20. Not part of the 110 vendored skills; carved out so the third_party_intake claim above stays literally true. The orchestrator-over-Opus-workers pattern recorded in docs/LANE_COORDINATION.md the same day, with the two review pitfalls the first fan-out produced." },
  ...
  { path: "docker-compose.migrate.yml", class: "tooling", reason: "Migration overlay publishing the bundled db to the loopback for the runbook's migrate-then-boot sequence; used by operators and the CI deploy-stack job alike." },
