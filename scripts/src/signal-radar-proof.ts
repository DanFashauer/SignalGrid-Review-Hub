...
// ── catalog ──────────────────────────────────────────────────────────────────
check("catalog lists the 20 evaluated categories (15 + the two launch families wired into the core on 2026-08-10 + the three DR-043 credential categories)", signalCatalog().evaluated.length === 20);
